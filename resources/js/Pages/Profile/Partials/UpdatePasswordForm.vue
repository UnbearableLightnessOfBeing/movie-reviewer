...
<template>
    <section>
        <header>
            <h2 class="text-lg font-medium text-secondary">Сменить пароль</h2>

            <p class="mt-1 text-sm text-secondary">
                Убедитесь, что Ваш аккаут имеет надежный пароль.
            </p>
        </header>

        <form @submit.prevent="updatePassword" class="mt-6 space-y-6">
            <div>
                <InputLabel class="text-secondary" for="current_password" value="Текущий пароль" />
            ...
            <div>
                <InputLabel class="text-secondary" for="password" value="Новый пароль" />
